...
namespace FluentContracts.Tests
{
    ...
    public class DateTimeContractTests : Tests
    {
        ...
        {
            TestContract<DateTime?, ArgumentOutOfRangeException>(
                null,
        ...
        {
            TestContract<DateTime?, ArgumentNullException>(
                DummyData.GetDateTime(),
                null,
        ...
        {
            var months = new Func<DateTime, string, Linker<DateTime>>[]
            {
        ...
        {
            var days = new (DayOfWeek Day, Func<DateTime, string, Linker<DateTime>> Contract)[]
            {
