...
public class FailureMessageTests
{
    ...
    public void EqualityCheckQuotesStrings()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => text.Must().Be("expected"));
    ...
    public void CheckNameBecomesTheExpectation()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => number.Must().BeEven());
    ...
    public void CheckNameHumanisesMultipleWords()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => letter.Must().NotBeLowercase());
    ...
    public void OperandChecksSpellOutTheExpectation()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => text.Must().StartWith("abc"));
    ...
    public void ParsingChecksNameTheFormat()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => email.Must().BeEmailAddress());
    ...
    public void UniquenessCheckNamesTheDuplicate()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => items.Must().HaveUniqueItems());
    ...
    public void DictionaryCheckNamesTheKey()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => map.Must().ContainKey("missing"));
    ...
    public void SatisfyDescribesTheConditionAsGiven()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => number.Must().Satisfy<int?>(n => n > 10));
    ...
    public void TypeCheckNamesExpectedAndActualType()
    {
        ...
        var exception = Assert.Throws<ArgumentOutOfRangeException>(() => value.Must().BeOfType<string>());
