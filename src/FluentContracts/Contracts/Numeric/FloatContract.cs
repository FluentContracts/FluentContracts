    ...
    where TContract : FloatContract<TContract>
{
    ...
    {
        Validator.CheckForGreaterThan(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    {
        Validator.CheckForLessOrEqualTo(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForLessThan(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForGreaterOrEqualTo(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    /// <returns>The contract, for chaining more checks</returns>
    public TContract Be(float expectedValue, string? message = null)
    {
    ...
    /// <param name="message">The optional error message to include in the exception.</param>
    /// <returns>The contract, for chaining more checks</returns>
    public TContract NotBe(float expectedValue, string? message = null)
    {
    ...
    public TContract BeAnyOf(float expectedValue)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeAnyOf(IEnumerable<float> expectedValues, string? message = null)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(float unexpectedValue)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(IEnumerable<float> unexpectedValues, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeBetween(float start, float end, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeGreaterThan(float value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeGreaterOrEqualTo(float value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeLessThan(float value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeLessOrEqualTo(float value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    {
        Validator.CheckForSpecificValue(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForNotSpecificValue(0f, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
