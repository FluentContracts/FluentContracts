    ...
    where TContract : FloatContract<TContract>
{
    ...
    /// <returns>The contract, for chaining more checks</returns>
    public TContract BeAnyOf(params float[] expectedValues)
    {
    ...
    /// <param name="expectedValues">Expected values among which the argument can be.</param>
    /// <returns>The contract, for chaining more checks</returns>
    public TContract BeAnyOf(string? message, params float[] expectedValues)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    public TContract NotBeAnyOf(params float[] expectedValues)
    {
    ...
    /// <param name="expectedValues">The expected values that the argument must not be.</param>
    /// <returns>The contract, for chaining more checks</returns>
    public TContract NotBeAnyOf(string? message, params float[] expectedValues)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
