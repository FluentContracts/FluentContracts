...
/// <summary>
/// The entry point for checks on a <see cref="ushort"/> argument. Obtained by calling <c>Must()</c>.
/// </summary>
...
public class UshortContract(ushort? argumentValue, string argumentName)
    : UshortContract<UshortContract>(argumentValue, argumentName);

/// <summary>
/// The inheritable contract for a <see cref="ushort"/> argument. A custom contract deriving from it
...
public class UshortContract<TContract> : ObjectContract<ushort?, TContract>
    where TContract : UshortContract<TContract>
{
    ...
    public TContract BeAnyOf(ushort expectedValue)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeAnyOf(IEnumerable<ushort> expectedValues, string? message = null)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(ushort unexpectedValue)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(IEnumerable<ushort> unexpectedValues, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
