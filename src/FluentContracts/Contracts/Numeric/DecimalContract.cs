    ...
    where TContract : DecimalContract<TContract>
{
    ...
    {
        Validator.CheckForGreaterThan(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    {
        Validator.CheckForLessOrEqualTo(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForLessThan(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForGreaterOrEqualTo(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    /// <returns>The contract, for chaining more checks</returns>
    public TContract Be(decimal expectedValue, string? message = null)
    {
    ...
    /// <param name="message">The optional error message to include in the exception.</param>
    /// <returns>The contract, for chaining more checks</returns>
    public TContract NotBe(decimal expectedValue, string? message = null)
    {
    ...
    public TContract BeAnyOf(decimal expectedValue)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeAnyOf(IEnumerable<decimal> expectedValues, string? message = null)
    {
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(decimal unexpectedValue)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract NotBeAnyOf(IEnumerable<decimal> unexpectedValues, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeBetween(decimal start, decimal end, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeGreaterThan(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeGreaterOrEqualTo(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeLessThan(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    /// <returns>The contract, for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public TContract BeLessOrEqualTo(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message ?? ChainMessage);
    ...
    {
        Validator.CheckForSpecificValue(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
    ...
    {
        Validator.CheckForNotSpecificValue(0m, ArgumentValue, ArgumentName, message ?? ChainMessage);
        return (TContract)this;
    }
}
