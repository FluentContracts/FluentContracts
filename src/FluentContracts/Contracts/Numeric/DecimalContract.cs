    ...
    where TContract : DecimalContract<TContract>
{
    ...
    {
        Validator.CheckForGreaterThan(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForLessOrEqualTo(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForLessThan(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForGreaterOrEqualTo(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> Be(decimal expectedValue, string? message = null)
    {
    ...
    /// <param name="message">The optional error message to include in the exception.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBe(decimal expectedValue, string? message = null)
    {
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> BeAnyOf(params decimal[] expectedValues)
    {
    ...
    /// <param name="expectedValues">Expected values among which the argument can be.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> BeAnyOf(string? message, params decimal[] expectedValues)
    {
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBeAnyOf(params decimal[] expectedValues)
    {
    ...
    /// <param name="expectedValues">The expected values that the argument must not be.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBeAnyOf(string? message, params decimal[] expectedValues)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    public Linker<TContract> BeBetween(decimal start, decimal end, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeGreaterThan(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeGreaterOrEqualTo(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeLessThan(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeLessOrEqualTo(decimal value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    {
        Validator.CheckForSpecificValue(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForNotSpecificValue(0m, ArgumentValue, ArgumentName, message);
        return _linker;
    }
}