    ...
    where TContract : LongContract<TContract>
{
    ...
    {
        Validator.CheckForGreaterThan(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForLessOrEqualTo(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForLessThan(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForGreaterOrEqualTo(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> Be(long expectedValue, string? message = null)
    {
    ...
    /// <param name="message">The optional error message to include in the exception.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBe(long expectedValue, string? message = null)
    {
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> BeAnyOf(params long[] expectedValues)
    {
    ...
    /// <param name="expectedValues">Expected values among which the argument can be.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> BeAnyOf(string? message, params long[] expectedValues)
    {
    ...
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBeAnyOf(params long[] expectedValues)
    {
    ...
    /// <param name="expectedValues">The expected values that the argument must not be.</param>
    /// <returns>Linker for chaining more checks</returns>
    public Linker<TContract> NotBeAnyOf(string? message, params long[] expectedValues)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    public Linker<TContract> BeBetween(long start, long end, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeGreaterThan(long value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeGreaterOrEqualTo(long value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeLessThan(long value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    /// <returns>Linker for chaining more checks</returns>
    /// <remarks>Also checks for the argument to NOT be null</remarks>
    public Linker<TContract> BeLessOrEqualTo(long value, string? message = null)
    {
        Validator.CheckForNotNull(ArgumentValue, ArgumentName, message);
    ...
    {
        Validator.CheckForSpecificValue(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
    ...
    {
        Validator.CheckForNotSpecificValue(0L, ArgumentValue, ArgumentName, message);
        return _linker;
    }
}